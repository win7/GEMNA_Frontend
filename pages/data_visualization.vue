...
myChart.setOption(option);
		...
		heatmap_changes (data) {
			...
			// var myColor = d3.scaleSequential(d3.domain([0, 1]), d3.interpolate("blue", "red"));
			...
			var mousemove = function(d) {
				tooltip
				.html("The exact value of<br>this cell is: " + d.weight2)
			...
			svg.selectAll()
				...
				.style("fill", function(d) { return myColor(d.weight2)} )
